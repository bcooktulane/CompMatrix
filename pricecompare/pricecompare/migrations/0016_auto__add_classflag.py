...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pricecompare_classflag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('flag_color', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'pricecompare', ['ClassFlag'])


    def backwards(self, orm):
        # Deleting model 'ClassFlag'
        db.delete_table(u'pricecompare_classflag')
