...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Carrier.code'
        db.delete_column(u'pricecompare_carrier', 'code')

        # Deleting field 'Carrier.group'
        db.delete_column(u'pricecompare_carrier', 'group')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Carrier.code'
        raise RuntimeError("Cannot reverse this migration. 'Carrier.code' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Carrier.group'
        raise RuntimeError("Cannot reverse this migration. 'Carrier.group' and its values cannot be restored.")
