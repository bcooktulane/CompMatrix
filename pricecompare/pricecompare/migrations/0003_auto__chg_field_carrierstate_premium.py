...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CarrierState.premium'
        db.alter_column(u'pricecompare_carrierstate', 'premium', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CarrierState.premium'
        raise RuntimeError("Cannot reverse this migration. 'CarrierState.premium' and its values cannot be restored.")
    ...
    models = {
        ...
        u'pricecompare.carrierstate': {
            ...
            'premium': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
