...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.max_credit'
        db.add_column(u'pricecompare_state', 'max_credit',
    ...
    def backwards(self, orm):
        # Deleting field 'State.max_credit'
        db.delete_column(u'pricecompare_state', 'max_credit')
    ...
    models = {
        ...
        u'pricecompare.state': {
            ...
            'max_debut': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }
