...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'LossCost', fields ['state', 'class_code']
        db.create_unique(u'pricecompare_losscost', ['state_id', 'class_code_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LossCost', fields ['state', 'class_code']
        db.delete_unique(u'pricecompare_losscost', ['state_id', 'class_code_id'])
