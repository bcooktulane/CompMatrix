...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'State.max_debit'
        db.alter_column(u'pricecompare_state', 'max_debit', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'State.max_credit'
        db.alter_column(u'pricecompare_state', 'max_credit', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'State.max_debit'
        db.alter_column(u'pricecompare_state', 'max_debit', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'State.max_credit'
        db.alter_column(u'pricecompare_state', 'max_credit', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        u'pricecompare.carrier': {
            ...
            'states': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pricecompare.State']", 'through': u"orm['pricecompare.CarrierState']", 'symmetrical': 'False'})
        },
        ...
        u'pricecompare.classcode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'states': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pricecompare.State']", 'through': u"orm['pricecompare.LossCost']", 'symmetrical': 'False'})
        },
        ...
        u'pricecompare.state': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_credit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '3', 'decimal_places': '2'}),
            'max_debit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '3', 'decimal_places': '2'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
