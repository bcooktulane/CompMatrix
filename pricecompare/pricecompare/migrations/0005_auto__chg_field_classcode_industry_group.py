...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClassCode.industry_group'
        db.alter_column(u'pricecompare_classcode', 'industry_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricecompare.IndustryGroup']))

    def backwards(self, orm):

        # Changing field 'ClassCode.industry_group'
        db.alter_column(u'pricecompare_classcode', 'industry_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pricecompare.Carrier']))
